                    ...
                    <div class="container">
                        <div class="main-header-two__top-details-inner">
                            <div class="main-header-two__logo">
                                <a href="index.html"><img src="{{ asset("assets/images/resources/logo-2.png") }}" alt=""></a>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                        <div class="feature-two__single">
                            <div class="feature-two__img">
                                <img src="{{ asset("assets/images/resources/feature-two-img-1.png") }}" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        <div class="feature-two__single">
                            <div class="feature-two__img">
                                <img src="{{ asset("assets/images/resources/feature-two-img-2.png") }}" alt="">
                            </div>
                            <div class="feature-two__content">
                                <div class="feature-two__content-inner">
                                    <div class="feature-two__icon">
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                        <div class="feature-two__single">
                            <div class="feature-two__img">
                                <img src="{{ asset("assets/images/resources/feature-two-img-3.png") }}" alt="">
                            </div>
                            <div class="feature-two__content">
                                <div class="feature-two__content-inner">
                                    <div class="feature-two__icon">
                        ...
                        <div class="work-together__left">
                            ...
                            <div class="work-together__content-box">
                                <div class="work-together__img">
                                    <img src="{{ asset("assets/images/resources/work-together-img.png") }}" alt="">
                                </div>
                    ...
                    <div class="col-xl-5">
                        <div class="get-insuracne-two__left">
                            ...
                            <div class="get-insuracne-two__img">
                                <img src="{{ asset("assets/images/resources/get-insurance-two-img-1.png") }}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-7">
                                ...
                                <div class="testimonial-two__wrap">
                                    ...
                                    <div class="testimonial-two__single">
                                        ...
                                        <div class="testimonial-two__founder-box">
                                            ...
                                            <div class="testimonial-two__client-img-box">
                                                <div class="testimonial-two__client-img">
                                                    <img src="{{ asset("assets/images/testimonial/testimonial-3-4.png") }}" alt="">
                                                </div>
                                                <div class="testimonial-two__quote">
                                                    <img src="{{ asset("assets/images/testimonial/testimonial-1-quote.png") }}" alt="">
                                                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                        <div class="news-two__single">
                            <div class="news-two__img">
                                <img src="{{ asset("assets/images/blog/news-2-1.png") }}" alt="">
                            ...
                            <div class="news-two__content">
                                ...
                                <div class="news-two__client">
                                    <div class="news-two__client-img">
                                        <img src="{{ asset("assets/images/blog/news-two-client-img-1.png") }}" alt="">
                                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        <div class="news-two__single">
                            <div class="news-two__img">
                                <img src="{{ asset("assets/images/blog/news-2-2.png") }}" alt="">
                                <div class="news-two__arrow-box">
                                    <a href="news-details.html" class="news-two__arrow">
                                        <span class="icon-right-arrow1"></span>
                                    </a>
                            ...
                            <div class="news-two__content">
                                ...
                                <div class="news-two__client">
                                    <div class="news-two__client-img">
                                        <img src="{{ asset("assets/images/blog/news-two-client-img-2.png") }}" alt="">
                                    </div>
                                    <div class="news-two__client-content">
                                        <p>by Admin</p>
                                        <h5>15 March, 2022</h5>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                        <div class="news-two__single">
                            <div class="news-two__img">
                                <img src="{{ asset("assets/images/blog/news-2-3.png") }}" alt="">
                                <div class="news-two__arrow-box">
                                    <a href="news-details.html" class="news-two__arrow">
                                        <span class="icon-right-arrow1"></span>
                                    </a>
                            ...
                            <div class="news-two__content">
                                ...
                                <div class="news-two__client">
                                    <div class="news-two__client-img">
                                        <img src="{{ asset("assets/images/blog/news-two-client-img-3.png") }}" alt="">
                                    </div>
                                    <div class="news-two__client-content">
                                        <p>by Admin</p>
                                        <h5>15 March, 2022</h5>
                                ...
                                <ul class="footer-widget__gallery-list list-unstyled clearfix">
                                    <li>
                                        <div class="footer-widget__gallery-img">
                                            <img src="{{ asset("assets/images/resources/footer-widget-gallery-img-1.png") }}" alt="">
                                            <a href="#"><span class="fa fa-link"></span></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="footer-widget__gallery-img">
                                            <img src="{{ asset("assets/images/resources/footer-widget-gallery-img-2.png") }}" alt="">
                                            <a href="#"><span class="fa fa-link"></span></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="footer-widget__gallery-img">
                                            <img src="{{ asset("assets/images/resources/footer-widget-gallery-img-3.png") }}" alt="">
                                            <a href="#"><span class="fa fa-link"></span></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="footer-widget__gallery-img">
                                            <img src="{{ asset("assets/images/resources/footer-widget-gallery-img-4.png") }}" alt="">
                                            <a href="#"><span class="fa fa-link"></span></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="footer-widget__gallery-img">
                                            <img src="{{ asset("assets/images/resources/footer-widget-gallery-img-5.png") }}" alt="">
                                            <a href="#"><span class="fa fa-link"></span></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="footer-widget__gallery-img">
                                            <img src="{{ asset("assets/images/resources/footer-widget-gallery-img-6.png") }}" alt="">
                                            <a href="#"><span class="fa fa-link"></span></a>
                                        </div>
                                    </li>
                                </ul>
