...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="home-showcase__item">
                                                                            <div class="home-showcase__image">
                                                                                <img src="{{ asset("
                                                                                    assets/images/home-showcase/home-showcase-1-1.jpg")
                                                                                    }}" alt="">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="home-showcase__item">
                                                                            <div class="home-showcase__image">
                                                                                <img src="{{ asset("
                                                                                    assets/images/home-showcase/home-showcase-1-2.jpg")
                                                                                    }}" alt="">
                                                                                <div class="home-showcase__buttons">
                                                                                    <a href="index2.html"
                                                                                        class="thm-btn home-showcase__buttons__item">Multi
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="home-showcase__item">
                                                                            <div class="home-showcase__image">
                                                                                <img src="{{ asset("
                                                                                    assets/images/home-showcase/home-showcase-1-3.jpg")
                                                                                    }}" alt="">
                                                                                <div class="home-showcase__buttons">
                                                                                    <a href="index3.html"
                                                                                        class="thm-btn home-showcase__buttons__item">Multi
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="home-showcase__item">
                                                                            <div class="home-showcase__image">
                                                                                <img src="{{ asset("
                                                                                    assets/images/home-showcase/home-showcase-1-4.jpg")
                                                                                    }}" alt="">
                                                                                <div class="home-showcase__buttons">
        ...
        <footer class="site-footer">
            <div class="site-footer-bg" style="background-image: url({{ asset("
                assets/images/backgrounds/site-footer-bg.png") }});">
            </div>
            <div class="container">
                                ...
                                <ul class="footer-widget__gallery-list list-unstyled clearfix">
                                    <li>
                                        <div class="footer-widget__gallery-img">
                                            <img src="{{ asset("
                                                assets/images/resources/footer-widget-gallery-img-1.jpg") }}" alt="">
                                    ...
                                    <li>
                                        <div class="footer-widget__gallery-img">
                                            <img src="{{ asset("
                                                assets/images/resources/footer-widget-gallery-img-2.jpg") }}" alt="">
                                            <a href="#"><span class="fa fa-link"></span></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="footer-widget__gallery-img">
                                            <img src="{{ asset("
                                                assets/images/resources/footer-widget-gallery-img-3.jpg") }}" alt="">
                                            <a href="#"><span class="fa fa-link"></span></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="footer-widget__gallery-img">
                                            <img src="{{ asset("
                                                assets/images/resources/footer-widget-gallery-img-4.jpg") }}" alt="">
                                            <a href="#"><span class="fa fa-link"></span></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="footer-widget__gallery-img">
                                            <img src="{{ asset("
                                                assets/images/resources/footer-widget-gallery-img-5.jpg") }}" alt="">
                                            <a href="#"><span class="fa fa-link"></span></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="footer-widget__gallery-img">
                                            <img src="{{ asset("
                                                assets/images/resources/footer-widget-gallery-img-6.jpg") }}" alt="">
                                            <a href="#"><span class="fa fa-link"></span></a>
                                        </div>
                                    </li>
                                </ul>
